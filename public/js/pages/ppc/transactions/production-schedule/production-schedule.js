...
function getDatatablesearch() {
  if ($('#from').val() != "" && $('#to').val() != "") {
    ProdSummariesTable(prodSummariesURL + '?fromvalue=' + $('#from').val() + '&tovalue=' + $('#to').val()); // getDatatable('tbl_prod_sum',prodSummariesURL + '?fromvalue='+ $('#from').val()+'&tovalue='+ $('#to').val(),dataColumn,[],0);
  } else if ($('#from').val() != "") {
    ProdSummariesTable(prodSummariesURL + '?fromvalue=' + $('#from').val()); // getDatatable('tbl_prod_sum',prodSummariesURL + '?fromvalue='+ $('#from').val(),dataColumn,[],0);
  } else {
...
function makeJODetailsList(arr) {
  ...
  $('#tbl_jo_details').dataTable({
    ...
    columns: [{
      ...
      data: function data(x) {
        return "<input type='text' id='material_used_" + x.count + "' value='" + x.material_used + "' data-count='" + x.count + "' data-pcode='" + x.prod_code + "' class='form-control form-control-sm material_used material_used_select' name='material_used[]'>" + "<div id='material_used_" + x.count + "_feedback' class='material_used__feedback'></div>";
      },
      searchable: false,
      orderable: false
    }, {
  ...
  $.each(joDetails_arr, function (i, x) {
    ...
    $.ajax({
      ...
      $.each(materials, function (indx, mat) {
        op += "<option value='" + mat.rmw_id + "' " + "data-heat_no='" + mat.heat_no + "' " + "data-uom='" + mat.uom + "' " + "data-rmw_issued_qty='" + mat.rmw_issued_qty + "' " + "data-rmw_scheduled_qty='" + mat.rmw_scheduled_qty + "' " + "data-rmw_id='" + mat.rmw_id + "' " + "data-inv_id='" + mat.inv_id + "' " + "data-rmw_length='" + mat.rmw_length + "' " + "data-upd_inv_id='" + mat.upd_inv_id + "' " + "data-material_type='" + mat.material_type + "' " + "data-for_over_issuance='" + mat.for_over_issuance + "' " + "data-standard_material_used='" + mat.standard_material_used + "' " + "data-description='" + mat.description + "' " + "data-size='" + mat.size + "' " + "data-item_code='" + mat.item_code + "' " + "data-schedule='" + mat.schedule + "' " + "'>" + mat.text + "</option>";
      });
  ...
  $('#tbl_travel_sheet').dataTable({
    ...
    columns: [{
      data: function data(_data) {
        return '<span class="cancel_travel_sheet"' + ' data-jo_no="' + _data.jo_no + '" data-prod_code="' + _data.product_code + '" ' + ' data-issued_qty="' + _data.issued_qty + '"data-id="' + _data.id + '" ' + ' data-status="' + _data.status + '"  data-sched_qty="' + _data.sched_qty + '" ' + ' data-qty_per_sheet="' + _data.qty_per_sheet + '"  data-iso_code="' + _data.iso_code + '"' + ' data-sc_no="' + _data.sc_no + '" data-idJO="' + _data.idJO + '"' + ' title="Cancel Travel Sheet"><i class="text-red fa fa-times"></i> </span>';
      },
      name: 'action',
      orderable: false,
      searchable: false
