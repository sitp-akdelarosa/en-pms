  ...
  $('#tbl_materials').dataTable({
    ...
    // }, searchable: false, sortable: false },
    {
      ...
      data: function data(x) {
        ...
        return "<input type='text' data-count='" + indx + "' name='material_used[]' id='material_used_" + indx + "' class='form-control form-control-sm material_used' value='" + x.material_used + "' readonly/>" + "<div id='material_used_" + indx + "_feedback' class='material_used__feedback'></div>";
      },
      searchable: false,
      sortable: false,
      width: "20.14%"
