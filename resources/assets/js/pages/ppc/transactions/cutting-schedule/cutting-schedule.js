			...
			if (x.trans_no.indexOf('JO') > -1) {
				...
				if (qty_needed_inbox) {
					...
					tbl_cut_details_body = "<tr>" +
						...
						"</td>" +
						"<td rowspan='2'>" + x.order_qty +
						"<input type='hidden' name='order_qty[]' value='" + x.order_qty + "'>" +
						"</td>" +
						"<td>" + x.issued_qty +
					...
					tbl_cut_details_body = "<tr>" +
						...
						"</td>" +
						"<td rowspan='2'>" +
						"<a href='javascript:;' style='color:#940000' class='fa fa-times btn_remove' data-id='" + x.id + "' data-issued_qty='" + x.needed_qty + "' data-count='" + count + "'></a>" +
						"</td>" +
						"</tr>" +
						"<tr>" +
						"<td><span class='pull-left'>-------</span><span class='pull-right'>" + x.lot_no + "</span></td>" +
