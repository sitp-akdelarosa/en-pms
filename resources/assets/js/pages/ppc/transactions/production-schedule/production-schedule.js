...
function SelectedItemsDataTable(arr) {
    ...
    $('#tbl_bom').DataTable({
        ...
        columns: [
            ...
            { data: function(x) {
                return "<input type='text' class='sched_qty form-control form-control-sm validate_bom' data-count='"+count+"' id='sched_qty_"+count+"' name='sched_qty[]' value='"+x.sched_qty+"' onkeypress='return isNumberKey(event)' />"+
