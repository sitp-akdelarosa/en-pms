<div id="modal_material_inventory" class="modal fade " data-backdrop="static">
    <div class="modal-dialog modal-full" role="document">
        <form method="POST" action="<?php echo e(url('/transaction/update-inventory/AddManual')); ?>" id="frm_material_inventory">
                    ...
                    <div class="row mb-15">
                        <div class="offset-md-7 col-md-5">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="date" class="form-control validate" name="received_date" id="received_date">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select-validate" name="materials_type" id="materials_type"></select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control select-validate" name="materials_code" id="materials_code">
                                        <option value=''></option>
                                    </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control validate" name="schedule" id="schedule">
                        ...
                        <div class="col-md-4">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" class="form-control validate" name="quantity" id="quantity" step="any">
                                    <div id="quantity_feedback"></div>
                                </div>

                                <label for="uom" class="col-sm-2 control-label mt-5">UOM:</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control validate" name="uom" id="uom">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control validate" name="heat_no" id="heat_no">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control validate" name="invoice_no" id="invoice_no">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control validate" name="supplier" id="supplier">
