		...
		<div class="tab-content">
			<div class="tab-pane active" id="material_code_assembly_tab">
				...
				<div class="row justify-content-center">
					<div class="col-md-8">
						<form method="post" action="<?php echo e(route('masters.material-master.save')); ?>" id="frm_mat_assembly">
							<?php echo csrf_field(); ?>
			...
			<div class="tab-pane" id="material_code_tab">
				<div class="row mb-5">
					<div class="col-md-4">
						...
						<form action="<?php echo e(url('/masters/material-master/save-code')); ?>" id="frm_mat_code">
							<?php echo csrf_field(); ?>
...
<script type="text/javascript">
	...
	var assemblyListURL = "<?php echo e(url('/masters/material-master/material-list')); ?>";
	var assemblyDeleteURL = "<?php echo e(url('/masters/material-master/destroy')); ?>";
	var materialTypeURL = "<?php echo e(url('/masters/material-master/material-type')); ?>";
	var matCodeListURL = "<?php echo e(url('/masters/material-master/get-mat-code-list')); ?>";
	var showDropdownURL = "<?php echo e(url('/masters/material-master/show-dropdowns')); ?>";
	var showCodeURL = "<?php echo e(url('/masters/material-master/show-code')); ?>";
