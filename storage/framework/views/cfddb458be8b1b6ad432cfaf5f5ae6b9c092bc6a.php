...
<section class="content">
	<div class="row justify-content-center">
        <div class="col-lg-12 col-md-10 col-sm-12 col-xs-12">
            <div class="box">
                <div class="box-body">
                    <form id="frm_operator" role="form" method="POST" action="<?php echo e(url('prod/reports/operators-output/search_operator')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(asset('/js/pages/production/reports/operators-output.js')); ?>"></script>
<?php $__env->stopPush(); ?>
