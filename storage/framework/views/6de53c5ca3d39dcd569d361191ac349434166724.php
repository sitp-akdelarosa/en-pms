...
<?php echo $__env->make('includes.modals.admin.user-type-modules-modal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php $__env->startPush('scripts'); ?>
	<script type="text/javascript">
		...
		var moduleListURL = "<?php echo e(url('/admin/user-type/module-list')); ?>";
		var saveUrl = "<?php echo e(route('admin.user-type.save')); ?>";
