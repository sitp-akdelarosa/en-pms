<div id="modal_transfer_entry" class="modal fade " data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <form id="frm_transfer_items" role="form" method="POST"  action="<?php echo e(url('/prod/transfer-item/save')); ?>">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" class="form-control" name="create_user" id="create_user" value="<?php echo e(Auth::user()->user_id); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" class="form-control" name="created_date" id="created_date" value="<?php echo e(date('m/d/Y')); ?>" readonly>
                                    </div>
                                </div>
                            </div>
							</div>
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" class="form-control" name="update_user" id="update_user" value="<?php echo e(Auth::user()->user_id); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" class="form-control" name="updated_date" id="updated_date" value="<?php echo e(date('m/d/Y')); ?>" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div id="modal_receive_item" class="modal fade " data-backdrop="static">
    <div class="modal-dialog col-md-3" role="document">
        <form id="frm_receive_item" role="form" method="POST"  action="<?php echo e(url('/prod/transfer-item/receive-process')); ?>">
            <div class="modal-content">
                <div class="modal-header">
